...
const Unity_SVGTextureMesh = ({
  svgUrl,
  iconUrl,
  title="Unity Game Engine",
  facts = ["A large ecosystem of Assets Ready to be used",
            "Support for Terrain modeling and advanced Rendering Techniques",
  ...
  useEffect(() => {
    ...
    const renderCanvas = () => {
      ...
      const factSpacing = canvas.height * 0.01;
...
export default Unity_SVGTextureMesh;